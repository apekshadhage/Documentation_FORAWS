...
|        | <br>Key strokes are defined by being placed inside of brackets. Ex. '[enter]', a full list of valid key strokes can be found starting at line 67 here.
|        |<br>Defining the current input field is done by placing the text SET_INFIELD inside brackets, followed by the x and y coordinates of the input field.
|| <br>Ex. [SET_INFIELD 3 4]
