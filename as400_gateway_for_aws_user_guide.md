...
Click on Create Subcription&rarr;select protocol(e.g. AWS Lambda) Enter a valid AWS Lambda ARN (for example, arn:aws:lambda:us-east-1:123456789012:function:MyLambdaFunction). After your subscription is created, you must confirm it.-->set bother properties according(Optional)click on Create Subscription
